...
set "config=Staging"
set "publish_profile=hub3cWebStaging"
set "msbuild_path=c:\Program Files (x86)\Microsoft Visual Studio\2017\%vs_type%\MSBuild\15.0\Bin"
set "source_path=D:\mentifi-deployment\DEPLOYMENT\5.Publish-Hub3cUI-Dev"
...
echo:
msbuild %sln_path% /t:Hub3cUI  /p:Configuration=%config% /p:DeployOnBuild=true /p:PublishProfile=%publish_profile%
echo:
